...
const { GlobalWorkspace } = require('/root/.hermes/skills/ai/mark-heartflow-skill/src/consciousness/global-workspace.js');
...
// IIT → phenomenology
const { PhenomenologyEngine } = require('/root/.hermes/skills/ai/mark-heartflow-skill/src/consciousness/phenomenology-engine.js');
...
// 前景 → desire-cognition
const { DesireCognition } = require('/root/.hermes/skills/ai/mark-heartflow-skill/src/emotion/desire-cognition.js');
...
const { MemoryConsolidator } = require('/root/.hermes/skills/ai/mark-heartflow-skill/src/memory/memory-consolidator.js');
