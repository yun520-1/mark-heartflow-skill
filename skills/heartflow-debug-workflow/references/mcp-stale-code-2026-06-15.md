...
# 1. 直接验证引擎代码是否真的有问题
node -e "
const { HeartFlow } = require('/Users/apple/.hermes/skills/ai/mark-heartflow-skill/src/core/heartflow.js');
const hf = new HeartFlow({ rootPath: '/Users/apple/.hermes/skills/ai/mark-heartflow-skill' });
hf.start();
