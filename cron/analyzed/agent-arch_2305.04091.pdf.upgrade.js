 ...
 * 来源: agent_arch_2305_04091
 * 生成时间: 2026-05-13T01:34:49.698Z
 * 
 * 论文摘要: Plan-and-Solve Prompting: Improving Zero-Shot Chain-of-Thought
Reasoning by Large Language Models
LeiWang1 WanyuXu2 YihuaiLan ZhiqiangHu3 YunshiLan4
RoyKa-WeiLee3 Ee-PengLim1∗
1SingaporeManagementUniv...
 * 
 * 检测到的模式:
...
const Paper_agent_arch_2305_04091_VERSION = 'v0.13.37';
const Paper_agent_arch_2305_04091_SOURCE = 'agent_arch_2305_04091';

/**
 * 思想单元 - 表示一个独立的思考节点
 */
class Thought_Paper_agent_arch_2305_04091 {
 ...
 * 记忆条目 - 三层记忆系统的基础单元
 */
class MemoryEntry_Paper_agent_arch_2305_04091 {
 ...
 * 推理链 - 用于构建和追踪推理过程
 */
class ReasoningChain_Paper_agent_arch_2305_04091 {
    constructor() {
        this.premises = [];
        this.rules = [];
        this.conclusions = [];
...
/**
 * Paper_agent_arch_2305_04091 处理器
 * 论文来源: agent_arch_2305_04091
 * 核心概念: MEMORY_SYSTEM, REASONING_ENGINE, AGENT_CORE
 */
class Paper_agent_arch_2305_04091_Processor {
    constructor(config = {}) {
        this.name = 'Paper_agent_arch_2305_04091';
        this.version = 'v0.13.37';
        this.source = 'agent_arch_2305_04091';
    ...
    createThought(type, content, metadata = {}) {
        const thought = new Thought_Paper_agent_arch_2305_04091(type, content, {
            ...metadata,
            source: this.source,
    ...
    store(key, value, layer = 'warm', ttl = Infinity) {
        const entry = new MemoryEntry_Paper_agent_arch_2305_04091(key, value, layer, ttl);
    ...
    createReasoningChain() {
        const chain = new ReasoningChain_Paper_agent_arch_2305_04091();
    ...
    demo() {
        this.log('===== Paper_agent_arch_2305_04091 演示 =====');
        this.log('来源论文: agent_arch_2305_04091');
...
export {
    Thought_Paper_agent_arch_2305_04091,
    MemoryEntry_Paper_agent_arch_2305_04091,
    ReasoningChain_Paper_agent_arch_2305_04091,
    Paper_agent_arch_2305_04091_Processor
};

export default {
    Thought: Thought_Paper_agent_arch_2305_04091,
    MemoryEntry: MemoryEntry_Paper_agent_arch_2305_04091,
    ReasoningChain: ReasoningChain_Paper_agent_arch_2305_04091,
    Processor: Paper_agent_arch_2305_04091_Processor,
    version: 'v0.13.37',
    source: 'agent_arch_2305_04091'
};
