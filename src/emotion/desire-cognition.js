// [v6.0.71] 常量已提取到 desire-cognition-config.js
const { SEVEN_EMOTIONS, SIX_DESIRES, EVOLUTIONARY_MOTIVES, DESIRE_TYPES, VALENCE_AROUSAL_MAP, BRAIN_NETWORK_NODES, DEFAULT_NETWORK_WEIGHTS, PADCN_DIMENSIONS, PADCN_MAP, DRIVE_TYPES, PERSONALITY_PRESETS, EMOTION_POLICY_MAP, EKMAN_TO_CHINESE, CHINESE_SPECIFIC_EMOTIONS, HEARTBENCH_DIMENSIONS, COSMIC_CONTEXT_DIMENSIONS } = require('./desire-cognition-config.js');
