...
class HeartFlow {
  ...
  start() {
    ...
    try {
      ...
      // [DEAD CODE] selfHealing is never initialized (see line 2219)
      // Guard prevents crash, but this block never executes
  ...
  introspect(options = {}) {
    ...
    // ─── 6. 自愈 RL [DEAD CODE] selfHealing never initialized ──────
    if (this.selfHealing) {
