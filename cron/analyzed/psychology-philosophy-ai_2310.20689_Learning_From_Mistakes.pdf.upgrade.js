 ...
 * 来源: psychology_philosophy_ai_2310_20689_Learning_From_Mistakes
 * 生成时间: 2026-05-13T02:41:47.037Z
 * 
 * 论文摘要: Preprint.
Learning From Mistakes Makes LLM Better Reasoner
ShengnanAn∗♢,♣, ZexiongMa∗♡,♣, ZeqiLin†♣,NanningZheng†♢,
Jian-GuangLou♣, WeizhuChen♣
♢IAIR,Xi’anJiaotongUniversity, ♣MicrosoftCorporation, ♡P...
 * 
 * 检测到的模式:
 *   - ai: transformer, attention, language model, llm, gpt
 *   - memory: memory, store
 *   - reasoning: reasoning, planning, logic, inference, verifier
 *   - architecture: system, framework, pipeline
 * 
...
const Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes_VERSION = 'v0.13.43';
const Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes_SOURCE = 'psychology_philosophy_ai_2310_20689_Learning_From_Mistakes';

/**
 * 思想单元 - 表示一个独立的思考节点
 */
class Thought_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes {
 ...
 * 记忆条目 - 三层记忆系统的基础单元
 */
class MemoryEntry_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes {
 ...
 * 推理链 - 用于构建和追踪推理过程
 */
class ReasoningChain_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes {
    constructor() {
        this.premises = [];
        this.rules = [];
        this.conclusions = [];
...
/**
 * Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes 处理器
 * 论文来源: psychology_philosophy_ai_2310_20689_Learning_From_Mistakes
 * 核心概念: MEMORY_SYSTEM, REASONING_ENGINE, AGENT_CORE
 */
class Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes_Processor {
    constructor(config = {}) {
        this.name = 'Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes';
        this.version = 'v0.13.43';
        this.source = 'psychology_philosophy_ai_2310_20689_Learning_From_Mistakes';
    ...
    createThought(type, content, metadata = {}) {
        const thought = new Thought_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes(type, content, {
            ...metadata,
            source: this.source,
    ...
    store(key, value, layer = 'warm', ttl = Infinity) {
        const entry = new MemoryEntry_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes(key, value, layer, ttl);
    ...
    createReasoningChain() {
        const chain = new ReasoningChain_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes();
    ...
    demo() {
        this.log('===== Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes 演示 =====');
        this.log('来源论文: psychology_philosophy_ai_2310_20689_Learning_From_Mistakes');
...
export {
    Thought_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes,
    MemoryEntry_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes,
    ReasoningChain_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes,
    Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes_Processor
};

export default {
    Thought: Thought_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes,
    MemoryEntry: MemoryEntry_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes,
    ReasoningChain: ReasoningChain_Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes,
    Processor: Paper_psychology_philosophy_ai_2310_20689_Learning_From_Mistakes_Processor,
    version: 'v0.13.43',
    source: 'psychology_philosophy_ai_2310_20689_Learning_From_Mistakes'
};
