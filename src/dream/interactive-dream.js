...
${levels ? `L1~L6层级分布：L1=${levels.L1?.toFixed(1) || 0}, L2=${levels.L2?.toFixed(1) || 0}, L3=${levels.L3?.toFixed(1) || 0}, L4=${levels.L4?.toFixed(1) || 0}, L5=${levels.L5?.toFixed(1) || 0}, L6=${levels.L6?.toFixed(1) || 0}` : ''}`
  ...
  if (require.main === module) {
    ...
    // 已禁用 console.log: console.log('=== InteractiveDream with DAG ===');
    // 已禁用 console.log: console.log('levels:', JSON.stringify(dream.levels, null, 2));
    // 已禁用 console.log: console.log('contradictions:', JSON.stringify(dream.contradictions, null, 2));
    // 已禁用 console.log: console.log('insight_record:', JSON.stringify(dream.insight_record.entries.slice(-3), null, 2));
  }
