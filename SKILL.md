...
├── identity/              # v0.13.34 身份引擎
├── memory/               # v0.13.34 三层记忆（hot/warm/cold）
├── dream/                # v0.13.34 梦境循环
├── emotion/              # v0.13.34 情绪引擎
├── self-healing/         # v0.13.34 自我修复
├── learning/             # v0.13.34 学习引擎
├── cognition/            # v0.13.34 认知引擎
├── consciousness/        # v0.13.34 意识引擎
├── autonomy/             # v0.13.34 自主决策
├── ethics/               # v0.13.34 伦理护栏
├── self-evolution/      # v0.13.34 自进化（Reflexion + SelfRefine）
└── skills/              # 技能注册表 + 加载器
...
- `references/reconstruction-methodology-v0.13.34.md` — v0.13.34 重建方法论
- `references/truthfulness-judgment-upgrade-v0.13.34.md` — 真善美判定引擎升级方法论
...
*HeartFlow v0.13.34 — 躯壳参考此文档，灵魂在 CORE_IDENTITY.md*
...
- `references/reconstruction-methodology-v0.13.34.md` — v0.13.34 重建方法论（路径深度陷阱 + 正则字符类陷阱 + 重建检查清单）
